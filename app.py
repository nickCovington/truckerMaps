...
def home():
    ...
    # The user adds the delivery information
    ...
    return flask.render_template(
        ...
        deliveryDetails=deliveryTable()
    )
def deliveryTable():
    timeExpected= flask.request.form.get("expected_at")
    localTime=time.ctime(time.time())
    timeDelivered=flask.request.form.get("timeDelivered")
    details=flask.request.form.get("details")
    deliveryInfo=delivery(
        expectedAt=timeExpected,
        deliveredAt=timeDelivered,
        details=details,
